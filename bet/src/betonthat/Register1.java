...
//        try{
//        String firstName = jLabel1.getText();
//        String lastName = jLabel2.getText();
//        String userName = jLabel3.getText();
//        String password = jLabel4.getText();
//        String email = jLabel5.getText();
//        Connection con = DriverManager.getConnection("jdbc:derby://localhost:1527/RegisterInfo", "Register", "Register");
//        Statement st = con.createStatement();
//     
//        st.execute("insert into RegisterInfo values ('"+firstName+"','"+lastName+"','"+userName+"','"+password+"','"+email+"')");
